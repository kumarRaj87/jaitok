...
//             <div
//               key={index}
//               className="relative group overflow-hidden rounded-lg aspect-[3/4] w-[300px] h-[350px] cursor-pointer"
//               onClick={() => handleCardClick(record.followingUser.id)}
//             >
//               <div className={`bg-gradient-to-br from-purple-500 to-pink-500 w-[300px] h-[350px] flex items-center justify-center`}>
...
//                     <h3 className="text-white font-bold text-lg mr-2">
//                       {record.followingUser.firstName} {record.followingUser.lastName}
//                     </h3>
//                     <CheckCircle className="w-5 h-5 text-[#FE2C55]" />
//                   </div>
//                   <p className="text-white/80 text-sm mb-3">{record.followingUser.email}</p>
//                   <button
//                     className="w-full bg-[#FE2C55] text-white py-2.5 rounded-md font-semibold hover:bg-[#e62a4f] transition-colors"
//                     onClick={(e) => {
//                       e.stopPropagation();
//                     }}
//                   >
