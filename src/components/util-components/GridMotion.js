...
const GridMotion = ({ items = [], gradientColor = "black" }) => {
  ...
  return (
    <div ref={gridRef} className="h-full w-[50vw] overflow-hidden flex justify-center items-center">
      <section
      ...
      >
        {/* Noise overlay */}
        <div className="absolute inset-0 pointer-events-none z-[4] bg-[url('')] bg-[length:250px]"></div>
